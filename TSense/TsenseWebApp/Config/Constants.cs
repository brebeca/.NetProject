...
namespace TsenseWebApp.Config
{
    static class Constants
    {
        ...
        public static readonly string TweetFromLinkUrl = "twitter_api/tweet?tweetLink=";// ConfigurationManager.AppSettings.Get("TweetFromLinkUrl");
        public static readonly string TweetsForUserUrl = "twitter_api/tweet_all?username=";// ConfigurationManager.AppSettings.Get("TweetsForUserUrl");
